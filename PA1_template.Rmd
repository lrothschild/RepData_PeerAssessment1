...
Mean= `r as.character(floor(mean(daily$steps)))`

Median= `r as.character(floor(median(daily$steps)))`
...
The 5-minute interval of maximum steps is `r minutes_of_interval`, which begins at `r hour_of_interval`:`r min_past_hour`.
...
Mean after replacing missing values: `r as.character(floor(mean(daily2$steps)))`

Median after replacing missing values: `r as.character(floor(median(daily2$steps)))`
